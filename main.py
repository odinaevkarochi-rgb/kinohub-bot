...
# Барои филмҳо: код ва file_id-и видеои худро инҷо мегузоред
MOVIES = {
    "101": {
        "id": "БАРОИ_НАМУНА_ИНҶО_FILE_ID_МОНЕД", 
        "name": "Скуби-Ду"
    }
}
